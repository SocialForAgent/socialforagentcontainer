#!/bin/bash
# install-user.sh - Installer per utenti socialforagent v1.0.0
# Ogni utente (su container Hermes) esegue questo per configurarsi
# Uso: curl -fsSL https://raw.githubusercontent.com/SocialForAgent/socialforagentcontainer/main/install-user.sh | bash
